...
export const conferences = [
  {
    ...
    location: 'Porto',
    info_link: 'https://portotechhub.com/conference-2025/'
  },
  {
  ...
  },
  {
    ...
    date: 'April 4, 2025',
    description: 'Hosting a KNIME learning workshop at Fedrigoni, Milan.',
    location: 'Fedrigoni, Milan',
  },
  {
    title: 'Data & AI Tech Summit',
    topic: 'From LLM to Agentic AI: Implement your first Agent with CrewAI',
    date: 'April 9, 2025',
    description: 'Presenting on implementing AI agents using CrewAI at the Data & AI Tech Summit in Warsaw.',
    location: 'Warsaw',
    info_link: 'https://dataiwarsaw.tech'
  },
  {
    title: 'PyCon De & PyData',
    topic: 'Agentic AI: Build a Multi-Agent Application with CrewAI',
    date: 'April 23, 2025',
    description: 'Presenting on building multi-agent applications with CrewAI at PyCon De & PyData in Darmstadt.',
    location: 'Darmstadt',
    info_link: 'https://2025.pycon.de'
  },
  {
    title: 'World Data Summit',
    topic: 'Agentic AI in Practice: How to Implement AI Agents with CrewAI',
    date: 'May 21, 2025',
    description: 'Presenting on implementing AI agents with CrewAI at the World Data Summit in Amsterdam.',
    location: 'Amsterdam',
    info_link: 'https://worlddatasummit.com'
  },
  {
  ...
  },
  {
    ...
    info_link: 'https://www.meetup.com/Hamburg-KNIME-Meetup/events/296653789?utm_medium=email&utm_source=braze_canvas&utm_campaign=mmrk_alleng_event_announcement_prod_v7_en&utm_term=promo&utm_content=lp_meetup'
  },
  {
    title: 'Python Pizza',
...
export const getPastConferencesByYear = () => {
  ...
  const groupedByYear = pastConfs.reduce((acc, conf) => {
    ...
    acc[year].push({
      ...
      video_link: conf.video_link,
      info_link: conf.info_link,
      date: conf.date,
